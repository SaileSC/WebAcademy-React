        ...
        <form onSubmit={handleSubmit(redireciona)}>
              ...
              <div className="mb-3">
                ...
                {errors.confirmaEmail?.type === "required" && (
                    <span className="text-danger fw-medium"> É obrigatorio confirmar email</span>
                )}

                {errors.confirmaEmail?.message && (
                    <span className="text-danger fw-medium"> {errors.confirmaEmail?.message}</span>
                )}
              </div>
              <div className="mb-3">
                ...
                {errors.senha?.type === "minLength" && (
                    <span className="text-danger fw-medium"> Minimo de caracteres para senha é 6 (seis)</span>
                )}
              </div>

              <div className="d-grid col-12">
                <button type="submit" className="btn btn-success">Confirmar cadastro </button>
              </div>
